$(function () {
    $("#ZoomIn").click(function (event) {
        ...
        var new_width = current_width * 1.2;
        var new_height = current_height * 1.2;
        ...
        if (width_distance > current_width) {
            ...
            new_left = current_left - (new_width - current_width) 
                    - (width_distance - current_width) * 0.2 / 2;
            ...
            if (width_distance > 0) {
                ...
                new_left = current_left - width_distance * 0.2;
            } else if (width_distance === 0) {
                console.log("width_distance === 0");
                new_left = current_left;
            } else {
                console.log("width_distance < 0");
                new_left = current_left - (width_distance * 0.2) / 2
            }
        }
        ...
        if (height_distance > current_height) {
            ...
            new_top = current_top - (new_height - current_height)
                    - (height_distance - current_height) * 0.2/2;
            ...
            if (height_distance > 0) {
                ...
                new_top = current_top - height_distance * 0.2;
            } else if (height_distance === 0) {
                console.log("height_distance === 0");
                new_top = current_top;
            } else {
                console.log("height_distance < 0");
                new_top = current_top - (height_distance * 0.2) / 2
            }
        }
    ...
    $("#ZoomOut").click(function (event) {
        ...
        $("#image").width(new_width);
        $("#image").height(new_height);
        var new_top = parseInt($("#image").css("top")) - (new_height - current_height) / 2;
        var new_left = parseInt($("#image").css("left")) - (new_width - current_width) / 2;
        console.log($("#image").css("top") + " -> " + new_top);
        console.log($("#image").css("left") + " -> " + new_left);
        $("#image").css({
            "top": new_top,
            "left": new_left
        });
